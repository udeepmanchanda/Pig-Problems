Movies = load '/Spring2015/movies_new.dat' using PigStorage('#') as (MovieID:chararray, Title:chararray, Genres:chararray);
...
Users = load '/Spring2015/users_new.dat' using PigStorage('#') as (UserID:chararray, Gender:chararray, Age:int, Occupation:chararray, Zipcode:chararray);
